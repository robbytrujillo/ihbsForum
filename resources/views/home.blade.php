        ...
        <section class="container hero">
          <div class="row align-items-center h-100">
            ...
            <div class="col-12 col-lg-6 h-315px order-first order-lg-last mb-3 mb-lg-0">
              <img class="hero-image float-lg-end" src="{{ url('assets/images/hero-green.png') }}" alt="hero">
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-6 mb-5 mb-lg-0">
                <img src="{{ url('assets/images/ihbsforum-logos.png') }}" alt="ihbs logo" class="h-28px mb-4">
                <p>Empowering The IHBS Community <br> to connect, share, and learn</p>
            </div>
            <div class="col-12 col-lg-6 me-auto">
              <div class="d-flex flex-column flex-lg-row justify-content-end">
                <div class="d-flex flex-column me-140px mb-3 mb-lg-0">
                  <p class="fw-bold fs-5 text-green text-nowrap">
                    Contact Us
                  </p>
                  <ul class="list-unstyled">
                    <li class="text-black">
                      <a href="mailto:robbyikusuma88@gmail.com">robbyikusuma88@gmail.com</a>
                    </li>
                  </ul>
                </div>
                <div class="d-flex flex-column">
                  <p class="fw-bold fs-5 text-green">Links</p>
                  <ul class="list-unstyled">
